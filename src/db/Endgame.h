...
private:
    ...
    static constexpr uchar DistanceBonus[8] = {0, 0, 100, 80, 60, 40, 20, 10};    //TODO stockfish
...
//    static int KRKP(const int tempo,const int winnerKingPos,const int loserKingPos,const int rookPos,const int pawnPos) {
...
//    static int KRKQ(const int winnerKingPos,const int loserKingPos) {
//        return VALUEQUEEN - VALUEROOK + MateTable[loserKingPos] + DistanceBonus[DISTANCE[winnerKingPos][loserKingPos]];
//    }

//    static int KRKB(const int loserKingPos) {
//        return MateTable[loserKingPos];
//    }

//    static int KRKN(const int loserKingPos,const int knightPos) {
...
//  static int KBBKN(const int winnerKingPos, const int loserKingPos, const int knightPos) {
...
//    }
//
//    static int KBNK(const int winnerKingPos,const int loserKingPos) {
